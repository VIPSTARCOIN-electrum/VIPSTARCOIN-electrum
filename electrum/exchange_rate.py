...
class BCEX(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('www.bcex.top', '/Api_Order/ticker?symbol=vipstarcoin2{}'.format(ccy.lower()))
...
class Huobi(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('api.huobi.pro', '/market/trade?symbol=vipstarcoin{}'.format(ccy.lower()))
...
class OKEX(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('www.okex.com', '/api/v1/ticker.do?symbol=vipstarcoin_{}'.format(ccy.lower()))
...
class AllCoin(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('www.allcoin.ca', '/Api_Order/ticker?symbol=vipstarcoin2{}'.format(ccy.lower()))
        result = {ccy: Decimal(json['data']['last'])}
        return result
