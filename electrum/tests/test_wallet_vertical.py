...
import lib
from lib import storage, vipstarcoin, keystore, constants
...
class TestWalletKeystoreAddressIntegrityForMainnet(SequentialTestCase):
    ...
    def test_electrum_seed_standard(self, mock_write):
        ...
        self.assertEqual(vipstarcoin.seed_type(seed_words), 'standard')
    ...
    def test_electrum_seed_segwit(self, mock_write):
        ...
        self.assertEqual(vipstarcoin.seed_type(seed_words), 'segwit')
...
class TestWalletSending(TestCaseForTestnet):
    ...
    def test_sending_between_p2wpkh_and_compressed_p2pkh(self, mock_write):
        ...
        # wallet1 -> wallet2
        outputs = [(vipstarcoin.TYPE_ADDRESS, wallet2.get_receiving_address(), 250000)]
        ...
        # wallet2 -> wallet1
        outputs = [(vipstarcoin.TYPE_ADDRESS, wallet1.get_receiving_address(), 100000)]
    ...
    def test_sending_between_p2sh_2of3_and_uncompressed_p2pkh(self, mock_write):
        ...
        # wallet1 -> wallet2
        outputs = [(vipstarcoin.TYPE_ADDRESS, wallet2.get_receiving_address(), 370000)]
        ...
        # wallet2 -> wallet1
        outputs = [(vipstarcoin.TYPE_ADDRESS, wallet1a.get_receiving_address(), 100000)]
        tx = wallet2.mktx(outputs=outputs, password=None, config=self.config, fee=5000)
    ...
    def test_sending_between_p2wsh_2of3_and_p2wsh_p2sh_2of2(self, mock_write):
        ...
        # wallet1 -> wallet2
        outputs = [(vipstarcoin.TYPE_ADDRESS, wallet2a.get_receiving_address(), 165000)]
        tx = wallet1a.mktx(outputs=outputs, password=None, config=self.config, fee=5000)
        txid = tx.txid()
        tx = Transaction(tx.serialize())  # simulates moving partial txn between cosigners
    ...
    def test_sending_between_p2sh_1of2_and_p2wpkh_p2sh(self, mock_write):
        ...
        # wallet1 -> wallet2
        outputs = [(vipstarcoin.TYPE_ADDRESS, wallet2.get_receiving_address(), 1000000)]
        tx = wallet1a.mktx(outputs=outputs, password=None, config=self.config, fee=5000)
        ...
        # wallet2 -> wallet1
        outputs = [(vipstarcoin.TYPE_ADDRESS, wallet1a.get_receiving_address(), 300000)]
        tx = wallet2.mktx(outputs=outputs, password=None, config=self.config, fee=5000)
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_xprv_online_xpub_p2pkh(self, mock_write):
        ...
        # create unsigned tx
        outputs = [(vipstarcoin.TYPE_ADDRESS, 'tb1qp0mv2sxsyxxfj5gl0332f9uyez93su9cf26757', 2500000)]
    ...
    def test_sending_offline_wif_online_addr_p2pkh(self, mock_write):  # compressed pubkey
        ...
        # create unsigned tx
        outputs = [(vipstarcoin.TYPE_ADDRESS, 'tb1quk7ahlhr3qmjndy0uvu9y9hxfesrtahtta9ghm', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, config=self.config, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
