...
from electrum.bitcoin import TYPE_ADDRESS, int_to_hex, var_int, TYPE_SCRIPT
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "VIPSTARCOIN" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in VIPSTARCOIN mode")) from e
                raise e
...
class Ledger_KeyStore(Hardware_KeyStore):
    ...
    def sign_transaction(self, tx, password):
        ...
        if not p2shTransaction:
            ...
            for o in tx.outputs():
                # assert _type == TYPE_ADDRESS # vipstarcoin diff
