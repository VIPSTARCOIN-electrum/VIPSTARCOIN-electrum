...
;Variables
  ...
  !define PRODUCT_NAME "VIPSTARCOIN-Electrum"
  !define PRODUCT_WEB_SITE "https://github.com/VIPSTARCOIN-electrum/VIPSTARCOIN-electrum"
  !define PRODUCT_PUBLISHER "VIPSTARCOIN Team"
...
Section
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-win-${PRODUCT_VERSION}.exe" ""

  ;Create start-menu items
  DetailPrint "Creating start-menu items..."
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Uninstall.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\Uninstall.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-win-${PRODUCT_VERSION}.exe" "" "$INSTDIR\electrum-win-${PRODUCT_VERSION}.exe" 0
  ...
  WriteRegStr HKCU "Software\Classes\vipstarcoin\shell\open\command" "" "$\"$INSTDIR\electrum-win-${PRODUCT_VERSION}.exe$\" $\"%1$\""
